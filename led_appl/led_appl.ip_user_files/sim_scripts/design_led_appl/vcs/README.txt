...
#
# Generated by export_simulation on Fri Oct 09 11:01:10 +0200 2020
#
################################################################################
...
'-reset_run' switch to the './design_led_appl.sh' script.

./design_led_appl.sh -reset_run
...
./design_led_appl.sh -noclean_files

For more information on the script, please type './design_led_appl.sh -help'.
