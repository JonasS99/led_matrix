...
HD_PWD='C:/Users/Keller/Desktop/Harald/201022_Projekt_400_leds/led_appl/led_appl.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_led_appl_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_led_appl_wrapper.tcl
