...
HD_PWD='C:/Users/Keller/Desktop/Projekt/led_appl/led_appl.runs/design_led_appl_clk_wiz_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_led_appl_clk_wiz_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_led_appl_clk_wiz_1_0.tcl
